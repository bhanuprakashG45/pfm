...
class ShopbySubcategoryView extends StatefulWidget {
  ...
  @override
  State<ShopbySubcategoryView> createState() => _ShopbySubcategoryViewState();
}
    ...
    return Scaffold(
      ...
      body: Consumer<ShopbycategoryViewmodel>(
        builder: (context, provider, child) {
          ...
          if (provider.subcategoryData.isEmpty) {
          ...
          return SafeArea(
            ...
            child: Stack(
              children: [
                ListView.builder(
                  cacheExtent: 1000,
                  itemCount: provider.subcategoryData.length + 1,
                  padding: EdgeInsets.all(10.w),
                  itemBuilder: (context, index) {
                    if (index == provider.subcategoryData.length) {
